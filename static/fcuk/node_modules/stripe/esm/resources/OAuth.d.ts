...
export declare class OAuthResource extends StripeResource {
    basePath: import("../Types.js").UrlInterpolator;
    authorizeUrl(params?: OAuthAuthorizeUrlParams, options?: OAuthAuthorizeUrlOptions): string;
    token(params: OAuthTokenParams, options?: RequestOptions): Promise<OAuthToken>;
    deauthorize(params: OAuthDeauthorizeParams, options?: RequestOptions): Promise<OAuthDeauthorization>;
}
...
declare namespace OAuthAuthorizeUrlParams {
