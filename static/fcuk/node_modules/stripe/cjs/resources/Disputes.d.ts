...
export declare class DisputeResource extends StripeResource {
     ...
     */
    list(params?: DisputeListParams, options?: RequestOptions): ApiListPromise<Dispute>;
    /**
     * Retrieves the dispute with the given ID.
     */
    retrieve(id: string, params?: DisputeRetrieveParams, options?: RequestOptions): Promise<Response<Dispute>>;
    /**
     * When you get a dispute, contacting your customer is always the best first step. If that doesn't work, you can submit evidence to help us resolve the dispute in your favor. You can do this in your [dashboard](https://dashboard.stripe.com/disputes), but if you prefer, you can use the API to submit evidence programmatically.
     *
     * Depending on your dispute type, different evidence fields will give you a better chance of winning your dispute. To figure out which evidence fields to provide, see our [guide to dispute types](https://docs.stripe.com/docs/disputes/categories).
     */
    update(id: string, params?: DisputeUpdateParams, options?: RequestOptions): Promise<Response<Dispute>>;
    /**
...
export declare namespace Dispute {
    type EnhancedEligibilityType = 'visa_compelling_evidence_3' | 'visa_compliance';
    interface Evidence {
        /**
    ...
    type Status = 'lost' | 'needs_response' | 'prevented' | 'under_review' | 'warning_closed' | 'warning_needs_response' | 'warning_under_review' | 'won';
    namespace Evidence {
    ...
    namespace EvidenceDetails {
        ...
        namespace EnhancedEligibility {
            ...
            namespace VisaCompellingEvidence3 {
                type RequiredAction = 'missing_customer_identifiers' | 'missing_disputed_transaction_description' | 'missing_merchandise_or_services' | 'missing_prior_undisputed_transaction_description' | 'missing_prior_undisputed_transactions';
    ...
    namespace PaymentMethodDetails {
        ...
        namespace Card {
            type CaseType = 'block' | 'chargeback' | 'compliance' | 'inquiry' | 'resolution';
        }
    }
}
...
export declare namespace DisputeUpdateParams {
    interface Evidence {
        /**
         ...
         */
        enhanced_evidence?: Emptyable<Evidence.EnhancedEvidence>;
        /**
        ...
        namespace EnhancedEvidence {
            ...
            namespace VisaCompellingEvidence3 {
                interface DisputedTransaction {
                     ...
                     * User Account ID used to log into business platform. Must be recognizable by the user.
                     */
                    customer_account_id?: Emptyable<string>;
                    /**
                     * Unique identifier of the cardholder's device derived from a combination of at least two hardware and software attributes. Must be at least 20 characters.
                     */
                    customer_device_fingerprint?: Emptyable<string>;
                    /**
                     * Unique identifier of the cardholder's device such as a device serial number (e.g., International Mobile Equipment Identity [IMEI]). Must be at least 15 characters.
                     */
                    customer_device_id?: Emptyable<string>;
                    /**
                     * The email address of the customer.
                     */
                    customer_email_address?: Emptyable<string>;
                    /**
                     * The IP address that the customer used when making the purchase.
                     */
                    customer_purchase_ip?: Emptyable<string>;
                    /**
                     * Categorization of disputed payment.
                     */
