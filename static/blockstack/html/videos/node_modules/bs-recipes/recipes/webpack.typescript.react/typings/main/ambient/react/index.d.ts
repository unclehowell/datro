...
// Definitions by: Asana <https://asana.com>, AssureSign <https://www.assuresign.com>, Microsoft <https://microsoft.com>
...
declare namespace __React {
    ...
    interface CSSProperties {
        ...
        /**
         * A future level of CSS Shapes will define a shape-inside property, which will define a shape to wrap content within the element. See Editor's Draft <https://dev.w3.org/csswg/css-shapes/> and CSSWG wiki page on next-level plans <https://wiki.csswg.org/spec/css-shapes>
         */
        shapeInside?: any;
