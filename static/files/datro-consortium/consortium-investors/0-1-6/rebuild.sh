...
printf "\e[2;3;33m HTML - http://localhost/datro-gh-pages/static/files/${PWD#${PWD%/*/*/*}/}/build/html/index.html \n\e[0m\n"
printf "\e[2;3;33m  PDF - http://localhost/datro-gh-pages/static/files/${PWD#${PWD%/*/*/*}/}/build/latex/datro_consortium-investors_detailed.pdf \n\e[0m\n"
