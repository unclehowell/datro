...
.. list-table:: 
   ...
   * - If to Seller
     - If to Buyer
   * - Google Inc.
     - Wave Telecom Limited. (formerly Make it Wave Ltd)
   * - 1600 Amphitheatre Parkway, Mountain View, CA 94043
     - Enterprise Industrial Estate, Enterprise Road, Waterlooville, England, PO8 0BB
   * - Attention: Legal - Patents
     - Attention: Wave Telecom Limited
   * - With a copy via electronic mail to: 
     - With a copy via electronic mail to: 
   * - patent-starter-program@google.com
     - hywelapbuckler@gmail.com (formerly info@makeitwave.com)
