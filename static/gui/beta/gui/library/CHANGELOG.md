...
13-Apr - Testing a serverless file indexing method, so gui.8cc.online/static/library will show the document directories as html   
...
### Issues
08-May - Need to get docs (html & PDF) to open links in new tab. Browser based PDF viewer doesn't show within iframes/ divs. And `library.datro.world` displays `gui.8cc.online/static/library` in a frame  
