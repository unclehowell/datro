...
cut -d, -f 1-3 wrt-master-register.csv > temp-wrt-master-register.csv
...
printf "\n\n${RED}DATRO${NC} - Getting Account - UID: 151 (F-Coldwell-Hall):  \n\n"
cd source/_static/custom
...
printf "\n\n${RED}DATRO${NC} - Getting Account - UID: 152 (E-Coldwell):  \n\n"
cd source/_static/custom
...
printf "\n\n${RED}DATRO${NC} - Getting Account - UID: 401 (M-Garza-&-Co):  \n\n"
cd source/_static/custom
