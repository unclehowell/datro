...
#. Head to https://translate.element.io and register either via Github or email
#. After registering check if you got an email to verify your account and click the link (if there is none head to step 1.4)
#. Log into weblate
#. Head to https://translate.element.io/accounts/profile/ and select the languages you know and maybe another language you know too.
#. Head to https://translate.element.io/accounts/profile/#subscriptions and select Element Web as Project
...
#. Head to one of the projects listed https://translate.element.io/projects/element-web/
#. Click on the ``translate`` button on the right side of your language
...
#. Go to one of the projects listed https://translate.element.io/projects/element-web/
#. Click the ``Start new translation`` button at the bottom
#. Select a language
