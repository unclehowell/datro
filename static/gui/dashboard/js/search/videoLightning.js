  ...
  (function(document) {
    ...
    VideoLightning = (function() {
      ...
      VideoLightning.prototype.buildOpts = function() {
        ...
        this.opts.width = this.opts.width ? parseInt(this.opts.width, 10) : (window.innerWidth - 100);
        this.opts.height = this.opts.height ? parseInt(this.opts.height, 5) : (window.innerHeight - 150);
        display_ratio = this.opts.height / this.opts.width;
        if (!this.opts.fullscreenAllowed && this.opts.width > (window.innerWidth - 60)) {
          this.opts.width = window.innerWidth - 60;
