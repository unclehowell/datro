...
[![npm version](https://badge.fury.io/js/%40reactivex%2Frxjs.svg)](https://badge.fury.io/js/%40reactivex%2Frxjs)
...
- [API Documentation (WIP)](https://reactivex.io/rxjs)
...
> Note: This additional syntax requires [transpiler support](https://babeljs.io/docs/plugins/transform-function-bind/) and this syntax may be completely withdrawn from TC39 without notice! Use at your own risk.
...
*replace **version** with the current version. See [docs](https://reactivex.io/rxjs/manual/installation.html#cdn).*
...
For Mac OS X with [Homebrew](https://brew.sh/):
