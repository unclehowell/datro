...
<div bs-panel>
    <div bs-panel-content="basic">
        <p class="lede">
            Browsersync is an open-source project created and maintained by the front-end designers/developers at <a href="https://www.wearejh.com">JH</a>
...
<div bs-panel>
    <div bs-panel-content="basic">
        ...
        <dl>
            ...
            <dd>
                <ul>
                    <li>If you have simple HTML, CSS &amp; JavaScript files, you need the <a href="https://www.browsersync.io/docs/options/#option-server">server option</a>.</li>
                    <li>If you already have an existing server setup (such as an Express app, Mamp, Rails etc, then you need the <a href="https://www.browsersync.io/docs/options/#option-proxy">proxy option</a>.</li>
        ...
        <hr>
        <p>Need more assistance? Please try our <a href="https://www.browsersync.io/docs/">documentation</a> for user guides or our <a href="https://stackoverflow.com/questions/tagged/browser-sync">stackoverflow</a> tag for answers to common problems.</p>
    </div>
</div>
<div bs-panel>
    <div bs-panel-content="basic">
