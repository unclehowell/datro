...
<div bs-panel>
    <div bs-panel-content="basic">
        <p class="lede">
            Browsersync is an open-source project created and maintained by the front-end designers/developers at [JH](https://www.wearejh.com)
...
<div bs-panel>
    <div bs-panel-content="basic">
        ...
        <dl>
            ...
            <dd>
                <ul>
                    <li>If you have simple HTML, CSS & JavaScript files, you need the [server option](https://www.browsersync.io/docs/options/#option-server).</li>
                    <li>If you already have an existing server setup (such as an Express app, Mamp, Rails etc, then you need the [proxy option](https://www.browsersync.io/docs/options/#option-proxy).</li>
        ...
        <hr>
        <p>Need more assistance? Please try our [documentation](https://www.browsersync.io/docs/) for user guides or our [stackoverflow](https://stackoverflow.com/questions/tagged/browser-sync) tag for answers to common problems.</p>
    </div>
</div>
<div bs-panel>
    <div bs-panel-content="basic">
