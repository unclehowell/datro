...
==================
  ...
  * Added new [documentation](https://senchalabs.github.com/connect)
  ...
  * Rewrote session middleware. The session API now allows for
    ...
    Click to view the new [session api](https://senchalabs.github.com/connect/middleware-session.html).
  ...
  * Added [limit()](https://senchalabs.github.com/connect/middleware-limit.html) middleware
  * Added [profiler()](https://senchalabs.github.com/connect/middleware-profiler.html) middleware
  * Added [responseTime()](https://senchalabs.github.com/connect/middleware-responseTime.html) middleware
...
==================
  ...
  * Removed connect(1), it is now [spark(1)](https://github.com/senchalabs/spark)
  ...
  * Removed _jsonrpc_ middleware, use [visionmedia/connect-jsonrpc](https://github.com/visionmedia/connect-jsonrpc)
...
==================
  ...
  * Revamped the api, view the [Connect documentation](https://extjs.github.com/Connect/index.html#Middleware-Authoring) for more info (hover on the right for menu)
  * Added [extended api docs](https://extjs.github.com/Connect/api.html)
