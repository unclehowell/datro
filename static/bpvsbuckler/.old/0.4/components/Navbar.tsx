...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="site-header sticky top-0 z-50 bg-slate-900 border-b border-slate-800 shadow-xl" aria-label="Main navigation">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-1">
              ...
              <button aria-label="Toggle theme" className="theme-toggle" onClick={() => {
