...
- Fixed `SH: not found` error on line 213 in install.sh caused by orphaned heredoc marker
- Added index.html for pirateclaw.datro.xyz website
- Added CNAME for pirateclaw.datro.xyz
