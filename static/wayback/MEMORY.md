...
### Lesson
Applied "DOCTYPE declaration" to `index.html` on `wayback` branch. Score: 30. Category: archive.

## Cycle 2
### wayback: viewport meta tag
...
### Lesson
Applied "viewport meta tag" to `index.html` on `wayback` branch. Score: 30. Category: archive.
