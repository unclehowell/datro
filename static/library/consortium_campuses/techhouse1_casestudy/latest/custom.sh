...
cd source/_static/custom
curl -f 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTPvPc3dndOPG0JzXX81tSorsaQAGt5Y8_LIbhh76Ri5HBAWVkFrshW98lPhtN8iizS73YmSzqyfnHw/pub?gid=1570540549&single=true&output=csv'  --location -o tech-house-901.csv
cut -d, -f 1-5 tech-house-901.csv > temp-tech-house-901.csv
mv temp-tech-house-901.csv tech-house-901.csv
cd ../../../
