# Gemini CLI Agent: Library Conventions

This document outlines the conventions for generating and managing documents within this library. Adhering to these conventions ensures that new documents are consistent with the existing structure and can be easily processed by the project's tools.
