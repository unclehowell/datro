Grant of Non-Exclusive Right & Licence
======================================================================
...
1. A transactional, nontransferable, nonexclusive right and license to sublicense the Products to Registered End-Users for use on computers located in the Region, for such Registered End-User's internal use only and without the further right to sublicense, distribute, transfer or transmit the Products;

2. A nontransferable, nonexclusive right and license to reproduce copies of the Products from the Master Copy for distribution only to End-Users in accordance with subsection (a) above;


3. A nontransferable, nonexclusive right and license to use the Demonstration Beta Copies for the sole purposes of
...
4. A nontransferable, nonexclusive right and license to use the Marks in conjunction with the licenses granted to Distributor in subsections (a), (b), and (c) above.
