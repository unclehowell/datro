...
or [jsDelivr](https://www.jsdelivr.com/#!immutable.js).
...
Or use an AMD loader (such as [RequireJS](https://requirejs.org/)):
...
If you're using [browserify](https://browserify.org/), the `immutable` npm module
...
[Read the docs](https://facebook.github.io/immutable-js/docs/) and eat your vegetables.
...
If you are using the [Chai Assertion Library](https://chaijs.com/), [Chai Immutable](https://github.com/astorije/chai-immutable) provides a set of assertions to use against `Immutable` collections.
