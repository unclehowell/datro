...
[![Bower](https://img.shields.io/bower/v/rxjs.svg)](https://bower.io/search/?q=rxjs)
[![NuGet](https://img.shields.io/nuget/v/RxJS-All.svg)](https://www.nuget.org/packages/RxJS-All/)
...
*...is a set of libraries to compose asynchronous and event-based programs using observable collections and [Array#extras](https://blogs.msdn.com/b/ie/archive/2010/12/13/ecmascript-5-part-2-array-extras.aspx) style composition in JavaScript*
...
The Reactive Extensions for JavaScript (RxJS) is a set of libraries for composing asynchronous and event-based programs using observable sequences and fluent query operators that many of you already know by [Array#extras](https://blogs.msdn.com/b/ie/archive/2010/12/13/ecmascript-5-part-2-array-extras.aspx) in JavaScript. Using RxJS, developers represent asynchronous data streams with Observables, query asynchronous data streams using our many operators, and parameterize the concurrency in the asynchronous data streams using Schedulers. Simply put, RxJS = Observables + Operators + Schedulers.
...
```
Next, we'll get the user input from an input, listening to the keyup event by using the `Rx.Observable.fromEvent` method.  This will either use the event binding from [jQuery](https://jquery.com), [Zepto](https://zeptojs.com/), [AngularJS](https://angularjs.org/), [Backbone.js](https://backbonejs.org/) and [Ember.js](https://emberjs.com/) if available, and if not, falls back to the native event binding.  This gives you consistent ways of thinking of events depending on your framework, so there are no surprises.
...
- Contact us
    ...
    - [StackOverflow rxjs](https://stackoverflow.com/questions/tagged/rxjs)
...
- Tutorials
    ...
    - [Rx Workshop](https://rxworkshop.codeplex.com/)
    - [Reactive Programming and MVC](https://aaronstacy.com/writings/reactive-programming-and-mvc/)
...
- Reference Material
    ...
    - [Intro to Rx](https://introtorx.com/)
    - [101 Rx Samples Wiki](https://rxwiki.wikidot.com/101samples)
    - [RxJS Design Guidelines](https://github.com/Reactive-Extensions/RxJS/tree/master/doc/designguidelines)
    - [Visualizing Reactive Streams](https://jaredforsyth.com/2015/03/06/visualizing-reactive-streams-hot-and-cold/)
...
- Books
    ...
    - [Intro to Rx](https://www.amazon.com/Introduction-to-Rx-ebook/dp/B008GM3YPM/)
    - [Programming Reactive Extensions and LINQ](https://www.amazon.com/Programming-Reactive-Extensions-Jesse-Liberty/dp/1430237473/)
...
There are a number of ways to get started with RxJS. The files are available on [cdnjs](https://cdnjs.com/libraries/rxjs/) and [jsDelivr](https://www.jsdelivr.com/#!rxjs).
...
### Installing with [Bower](https://bower.io/)

```bash
$ bower install rxjs
```

### Installing with [Jam](https://jamjs.org/)
```bash
$ jam install rx
```
### Installing All of RxJS via [NuGet](https://www.nuget.org/)
```bash
$ Install-Package RxJS-All
```
### Install individual packages via [NuGet](https://www.nuget.org/):
