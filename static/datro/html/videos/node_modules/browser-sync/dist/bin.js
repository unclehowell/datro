 ...
 *
 *           eg: browser-sync https://example.com
 * is equal to: browser-sync start --proxy https://example.com
 *
 *           eg: browser-sync https://example.com themes/example
 * is equal to: browser-sync start --proxy https://example.com --ss themes/example
 *
 * @param argv
 * @param input
 * @returns {any}
