...
export declare class ReportRunResource extends StripeResource {
    /**
     * Returns a list of Report Runs, with the most recent appearing first.
     */
    list(params?: Reporting.ReportRunListParams, options?: RequestOptions): ApiListPromise<ReportRun>;
    /**
     * Creates a new object and begin running the report. (Certain report types require a [live-mode API key](https://stripe.com/docs/keys#test-live-modes).)
     */
    create(params: Reporting.ReportRunCreateParams, options?: RequestOptions): Promise<Response<ReportRun>>;
    /**
     * Retrieves the details of an existing Report Run.
     */
    retrieve(id: string, params?: Reporting.ReportRunRetrieveParams, options?: RequestOptions): Promise<Response<ReportRun>>;
}
