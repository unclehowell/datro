...
export declare namespace PaymentIntent {
    ...
    namespace AmountDetails {
        ...
        namespace Error {
            type Code = 'amount_details_amount_mismatch' | 'amount_details_tax_shipping_discount_greater_than_amount';
        }
    }
    ...
    namespace PaymentMethodOptions {
        ...
        namespace UsBankAccount {
            ...
            type SetupFutureUsage = 'none' | 'off_session' | 'on_session';
            type TransactionPurpose = 'goods' | 'other' | 'services' | 'unspecified';
            type VerificationMethod = 'automatic' | 'instant' | 'microdeposits';
